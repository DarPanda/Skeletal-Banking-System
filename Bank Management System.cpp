...
virtual void calcInt(){
    float interest_amount = balance * (interest_rate/100);
...
public:
    ...
    saving(){
    cout<<"             Bank Of Cyber Technicians"<<endl<<endl;
    }
...
void display(){
    ...
    cout<<"  "<<account_no<<setw(20)<<" "<<no_deposits<<setw(15)<<" "<<no_withdrawals<<setw(14)<<" "<<balance<<setw(7)<<" "<<status(account_no)<<endl;
    cout<<"  ----------------------------------------------------------------------"<<endl;
}
...
void store_modify_account(int a){
	...
	while(!In.eof() && x==1)
	{
		...
		if(acc.return_account_no()==a)
		{
		    ...
		    cout<<"Account Data Updated"<<endl<<endl;
		    x=x-1;
		  }
	}
	In.close();
...
do{
    ...
    switch(choice){
        ...
        case 3:
            ...
            break;
        case 4:
            cout<<"Good Work Admin of Bank Of Cyber Technicians !!!!!"<<endl<<endl;
